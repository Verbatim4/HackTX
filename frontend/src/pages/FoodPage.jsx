...
const FoodPage = () => {
  ...
  useEffect(() => {
    dispatch(getBenefitsByCategory('food'))
    ...
    <div className="min-h-screen gradient-bg">
      ...
      <div className="sticky top-0 bg-purple-900/50 backdrop-blur-lg z-10 p-6 flex justify-between items-center">
        <div className="flex items-center space-x-4">
          ...
          <h1 className="text-3xl font-bold text-white">{t('benefits.food.title')}</h1>
        </div>
        <AlertsPanel />
      </div>
      ...
      <div className="container mx-auto px-6 pt-6">
        <motion.div
          ...
          className="bg-gradient-to-r from-yellow-500/30 to-yellow-600/40 backdrop-blur-sm rounded-2xl p-6 shadow-xl mb-8 border border-yellow-400/20"
        >
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h2 className="text-2xl font-bold text-white">Total Food Benefits</h2>
                <p className="text-yellow-200">Your monthly food benefit amount</p>
              </div>
            </div>
            <div className="text-right">
              <div className="text-4xl font-bold text-white">
                ${(profile?.benefits?.snap || 0).toLocaleString()}
              </div>
